...
import { Button, Col, Form, FormControl, FormGroup, FormLabel, InputGroup, Nav, Row } from 'react-bootstrap';
import FormRange from 'react-bootstrap/esm/FormRange';
import BootstrapNavigation from './BootstrapNavigation';

const BootstrapForms1: React.FC = () => {
    return (
...
export default BootstrapForms1;